...
HLS_SOURCES = ../../../../userdma_test.cpp ../../../../userdma.cpp
...
$(ObjDir)/userdma.o: ../../../../userdma.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../userdma.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/userdma.d
