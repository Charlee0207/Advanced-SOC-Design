...
set IPName      "userdma"
set Version     "1.0"
set DisplayName "Userdma"
set Revision    "2113576361"
...
set xo_kernel_name "userdma"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/chngh/Desktop/2024spring/Advanced_SOC_Design/lab4_fsic-fpga/fsic_fpga/vivado/vitis_prj/hls_userdma/hls_userdma.prj/solution1"
set debug_dir "/home/chngh/Desktop/2024spring/Advanced_SOC_Design/lab4_fsic-fpga/fsic_fpga/vivado/vitis_prj/hls_userdma/hls_userdma.prj/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {userdma_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 s2m_buf_sts R 0x0 "Data signal of s2m_buf_sts" {{0 1 s2m_buf_sts R 0 "Bit 0 to 0 of s2m_buf_sts"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x14 s2m_buf_sts_ctrl R 0x0 "Control signal of s2m_buf_sts" {{0 1 s2m_buf_sts_ap_vld R 0 "Control signal s2m_buf_sts_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 s2m_sts_clear W 0x0 "Data signal of s2m_sts_clear" {{0 1 s2m_sts_clear W 0 "Bit 0 to 0 of s2m_sts_clear"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 s2m_len W 0x0 "Data signal of s2m_len" {{0 32 s2m_len W 0 "Bit 31 to 0 of s2m_len"}}} {0x30 s2m_enb_clrsts W 0x0 "Data signal of s2m_enb_clrsts" {{0 1 s2m_enb_clrsts W 0 "Bit 0 to 0 of s2m_enb_clrsts"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 s2mbuf_1 W 0x0 "Data signal of s2mbuf" {{0 32 s2mbuf W 0 "Bit 31 to 0 of s2mbuf"}}} {0x3c s2mbuf_2 W 0x0 "Data signal of s2mbuf" {{0 32 s2mbuf W 0 "Bit 63 to 32 of s2mbuf"}}} {0x44 s2m_err R 0x0 "Data signal of s2m_err" {{0 1 s2m_err R 0 "Bit 0 to 0 of s2m_err"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 s2m_err_ctrl R 0x0 "Control signal of s2m_err" {{0 1 s2m_err_ap_vld R 0 "Control signal s2m_err_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x54 Img_width W 0x0 "Data signal of Img_width" {{0 32 Img_width W 0 "Bit 31 to 0 of Img_width"}}} {0x5c m2sbuf_1 W 0x0 "Data signal of m2sbuf" {{0 32 m2sbuf W 0 "Bit 31 to 0 of m2sbuf"}}} {0x60 m2sbuf_2 W 0x0 "Data signal of m2sbuf" {{0 32 m2sbuf W 0 "Bit 63 to 32 of m2sbuf"}}} {0x68 m2s_buf_sts R 0x0 "Data signal of m2s_buf_sts" {{0 1 m2s_buf_sts R 0 "Bit 0 to 0 of m2s_buf_sts"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x6c m2s_buf_sts_ctrl R 0x0 "Control signal of m2s_buf_sts" {{0 1 m2s_buf_sts_ap_vld R 0 "Control signal m2s_buf_sts_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 m2s_sts_clear W 0x0 "Data signal of m2s_sts_clear" {{0 1 m2s_sts_clear W 0 "Bit 0 to 0 of m2s_sts_clear"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 m2s_len W 0x0 "Data signal of m2s_len" {{0 32 m2s_len W 0 "Bit 31 to 0 of m2s_len"}}} {0x88 m2s_enb_clrsts W 0x0 "Data signal of m2s_enb_clrsts" {{0 1 m2s_enb_clrsts W 0 "Bit 0 to 0 of m2s_enb_clrsts"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem0 m_axi_gmem1 inStreamTop outStreamTop"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem0 {
        ...
        handshake ""
        busParams "NUM_READ_OUTSTANDING 16 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 64 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE WRITE_ONLY HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "gmem0"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_gmem1 {
        ...
        preferredUsageValue "MEMORY"
        handshake ""
        busParams "NUM_READ_OUTSTANDING 16 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 64 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE READ_ONLY HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "gmem1"
        ctype {
            AWLEN {
                Type "integer unsigned"
