...
architecture behav of userdma is 
    ...
    "userdma_userdma,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=17,HLS_SYN_DSP=0,HLS_SYN_FF=4591,HLS_SYN_LUT=5705,HLS_VERSION=2023_1}";
    ...
    signal s2m_sts_clear : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal m2s_sts_clear : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal getinstream_U0_incount_din : STD_LOGIC_VECTOR (31 downto 0);
    signal getinstream_U0_incount_write : STD_LOGIC;
    ...
    signal streamtoparallelwithburst_U0_incount_read : STD_LOGIC;
    ...
    signal paralleltostreamwithburst_U0_outcount_din : STD_LOGIC_VECTOR (31 downto 0);
    signal paralleltostreamwithburst_U0_outcount_write : STD_LOGIC;
    ...
    signal sendoutstream_U0_outcount_read : STD_LOGIC;
...
begin
    ...
    port map (
        ...
        incount_din => getinstream_U0_incount_din,
        incount_num_data_valid => incount_num_data_valid,
        incount_fifo_cap => incount_fifo_cap,
        incount_full_n => incount_full_n,
        incount_write => getinstream_U0_incount_write,
    ...
    port map (
        ...
        incount_dout => incount_dout,
        incount_num_data_valid => incount_num_data_valid,
        incount_fifo_cap => incount_fifo_cap,
        incount_empty_n => incount_empty_n,
        incount_read => streamtoparallelwithburst_U0_incount_read,
    ...
    port map (
        ...
        outcount_din => paralleltostreamwithburst_U0_outcount_din,
        outcount_num_data_valid => outcount_num_data_valid,
        outcount_fifo_cap => outcount_fifo_cap,
        outcount_full_n => outcount_full_n,
        outcount_write => paralleltostreamwithburst_U0_outcount_write,
    ...
    port map (
        ...
        outcount_dout => outcount_dout,
        outcount_num_data_valid => outcount_num_data_valid,
        outcount_fifo_cap => outcount_fifo_cap,
        outcount_empty_n => outcount_empty_n,
        outcount_read => sendoutstream_U0_outcount_read,
