...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { outStreamTop_TDATA { O 32 vector } outStreamTop_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { outStreamTop_TVALID { O 1 bit } outStreamTop_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_phi_out { O 1 vector } p_phi_out_ap_vld { O 1 bit } } \
} "
}
