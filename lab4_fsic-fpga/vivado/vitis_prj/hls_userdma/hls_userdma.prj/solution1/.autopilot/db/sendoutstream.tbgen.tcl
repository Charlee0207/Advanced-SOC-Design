...
set C_modelArgList {
	{ outbuf int 40 regular {fifo 0 volatile }  }
	{ outcount int 32 regular {fifo 0 volatile }  }
	{ in_en_clrsts int 1 regular {fifo 0}  }
	{ m2s_buf_sts int 1 regular {pointer 1}  }
	{ sts_clear int 1 regular {fifo 0}  }
	{ outStreamTop_V_data_V int 32 regular {axi_s 1 volatile  { outStreamTop Data } }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "outbuf", "interface" : "fifo", "bitwidth" : 40, "direction" : "READONLY"} , 
 	{ "Name" : "outcount", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "in_en_clrsts", "interface" : "fifo", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "m2s_buf_sts", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sts_clear", "interface" : "fifo", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "outStreamTop_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ outbuf_empty_n sc_in sc_logic 1 signal 0 } 
	{ outbuf_read sc_out sc_logic 1 signal 0 } 
	{ outcount_dout sc_in sc_lv 32 signal 1 } 
	{ outcount_num_data_valid sc_in sc_lv 7 signal 1 } 
	{ outcount_fifo_cap sc_in sc_lv 7 signal 1 } 
	{ outcount_empty_n sc_in sc_logic 1 signal 1 } 
	{ outcount_read sc_out sc_logic 1 signal 1 } 
	{ in_en_clrsts_dout sc_in sc_lv 1 signal 2 } 
	{ in_en_clrsts_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ in_en_clrsts_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ in_en_clrsts_empty_n sc_in sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outbuf_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outbuf", "role": "empty_n" }} , 
 	{ "name": "outbuf_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outbuf", "role": "read" }} , 
 	{ "name": "outcount_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "outcount", "role": "dout" }} , 
 	{ "name": "outcount_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "outcount", "role": "num_data_valid" }} , 
 	{ "name": "outcount_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "outcount", "role": "fifo_cap" }} , 
 	{ "name": "outcount_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outcount", "role": "empty_n" }} , 
 	{ "name": "outcount_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outcount", "role": "read" }} , 
 	{ "name": "in_en_clrsts_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "in_en_clrsts", "role": "dout" }} , 
 	{ "name": "in_en_clrsts_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "in_en_clrsts", "role": "num_data_valid" }} , 
 	{ "name": "in_en_clrsts_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "in_en_clrsts", "role": "fifo_cap" }} , 
 	{ "name": "in_en_clrsts_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_en_clrsts", "role": "empty_n" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"Port" : [
			{"Name" : "outbuf", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sendoutstream_Pipeline_VITIS_LOOP_149_2_fu_103", "Port" : "outbuf", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "outcount", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "outStreamTop_V_data_V", "Type" : "Axis", "Direction" : "O", "BaseName" : "outStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sendoutstream_Pipeline_VITIS_LOOP_149_2_fu_103", "Port" : "outStreamTop_V_data_V", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "outStreamTop_V_keep_V", "Type" : "Axis", "Direction" : "O", "BaseName" : "outStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sendoutstream_Pipeline_VITIS_LOOP_149_2_fu_103", "Port" : "outStreamTop_V_keep_V", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "outStreamTop_V_strb_V", "Type" : "Axis", "Direction" : "O", "BaseName" : "outStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sendoutstream_Pipeline_VITIS_LOOP_149_2_fu_103", "Port" : "outStreamTop_V_strb_V", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "outStreamTop_V_user_V", "Type" : "Axis", "Direction" : "O", "BaseName" : "outStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sendoutstream_Pipeline_VITIS_LOOP_149_2_fu_103", "Port" : "outStreamTop_V_user_V", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "outStreamTop_V_last_V", "Type" : "Axis", "Direction" : "O", "BaseName" : "outStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sendoutstream_Pipeline_VITIS_LOOP_149_2_fu_103", "Port" : "outStreamTop_V_last_V", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_147_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "5", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state5"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sendoutstream_Pipeline_VITIS_LOOP_149_2_fu_103", "Parent" : "0",
...
set Spec2ImplPortList { 
	outbuf { ap_fifo {  { outbuf_dout fifo_port_we 0 40 }  { outbuf_num_data_valid fifo_status_num_data_valid 0 11 }  { outbuf_fifo_cap fifo_update 0 11 }  { outbuf_empty_n fifo_status 0 1 }  { outbuf_read fifo_data 1 1 } } }
	outcount { ap_fifo {  { outcount_dout fifo_port_we 0 32 }  { outcount_num_data_valid fifo_status_num_data_valid 0 7 }  { outcount_fifo_cap fifo_update 0 7 }  { outcount_empty_n fifo_status 0 1 }  { outcount_read fifo_data 1 1 } } }
	in_en_clrsts { ap_fifo {  { in_en_clrsts_dout fifo_port_we 0 1 }  { in_en_clrsts_num_data_valid fifo_status_num_data_valid 0 2 }  { in_en_clrsts_fifo_cap fifo_update 0 2 }  { in_en_clrsts_empty_n fifo_status 0 1 }  { in_en_clrsts_read fifo_data 1 1 } } }
	m2s_buf_sts { ap_vld {  { m2s_buf_sts out_data 1 1 }  { m2s_buf_sts_ap_vld out_vld 1 1 } } }
	sts_clear { ap_fifo {  { sts_clear_dout fifo_port_we 0 1 }  { sts_clear_num_data_valid fifo_status_num_data_valid 0 3 }  { sts_clear_fifo_cap fifo_update 0 3 }  { sts_clear_empty_n fifo_status 0 1 }  { sts_clear_read fifo_data 1 1 } } }
	outStreamTop_V_data_V { axis {  { outStreamTop_TDATA out_data 1 32 } } }
