set moduleName paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2
set isTopModule 0
...
set C_modelName {paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 0}  }
	{ sext_ln106 int 62 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "m2sbuf","offset": { "type": "dynamic","port_name": "m2sbuf","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln106", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln106 sc_in sc_lv 62 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln106", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln106", "role": "default" }} , 
 	...
 	{ "name": "m2s_len_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "m2s_len", "role": "o" }} , 
 	{ "name": "m2s_len_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "m2s_len", "role": "o_ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln106 { ap_none {  { sext_ln106 in_data 0 62 } } }
