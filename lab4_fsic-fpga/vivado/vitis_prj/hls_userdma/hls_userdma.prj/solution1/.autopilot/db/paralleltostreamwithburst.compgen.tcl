...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_in_memory \
    op interface \
    ports { in_memory { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_in_Img_width \
    op interface \
    ports { in_Img_width { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_outbuf \
    op interface \
    ports { outbuf_din { O 40 vector } outbuf_num_data_valid { I 11 vector } outbuf_fifo_cap { I 11 vector } outbuf_full_n { I 1 bit } outbuf_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_outcount \
    op interface \
    ports { outcount_din { O 32 vector } outcount_num_data_valid { I 7 vector } outcount_fifo_cap { I 7 vector } outcount_full_n { I 1 bit } outcount_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_m2s_enb_clrsts_c \
    op interface \
    ports { m2s_enb_clrsts_c_din { O 1 vector } m2s_enb_clrsts_c_num_data_valid { I 2 vector } m2s_enb_clrsts_c_fifo_cap { I 2 vector } m2s_enb_clrsts_c_full_n { I 1 bit } m2s_enb_clrsts_c_write { O 1 bit } } \
} "
}
