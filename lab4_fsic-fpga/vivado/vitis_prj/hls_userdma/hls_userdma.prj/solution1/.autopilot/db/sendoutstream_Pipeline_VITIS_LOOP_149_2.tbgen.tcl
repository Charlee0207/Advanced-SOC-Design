set moduleName sendoutstream_Pipeline_VITIS_LOOP_149_2
set isTopModule 0
...
set C_modelName {sendoutstream_Pipeline_VITIS_LOOP_149_2}
...
set portList { 
	...
	{ outbuf_dout sc_in sc_lv 40 signal 1 } 
	{ outbuf_num_data_valid sc_in sc_lv 11 signal 1 } 
	{ outbuf_fifo_cap sc_in sc_lv 11 signal 1 } 
	{ outbuf_empty_n sc_in sc_logic 1 signal 1 } 
	{ outbuf_read sc_out sc_logic 1 signal 1 } 
	{ outStreamTop_TDATA sc_out sc_lv 32 signal 2 } 
	{ outStreamTop_TVALID sc_out sc_logic 1 outvld 6 } 
	{ outStreamTop_TREADY sc_in sc_logic 1 outacc 2 } 
	{ outStreamTop_TKEEP sc_out sc_lv 4 signal 3 } 
	{ outStreamTop_TSTRB sc_out sc_lv 4 signal 4 } 
	{ outStreamTop_TUSER sc_out sc_lv 7 signal 5 } 
	{ outStreamTop_TLAST sc_out sc_lv 1 signal 6 } 
	{ p_phi_out sc_out sc_lv 1 signal 7 } 
	{ p_phi_out_ap_vld sc_out sc_logic 1 outvld 7 } 
}
set NewPortList {[ 
