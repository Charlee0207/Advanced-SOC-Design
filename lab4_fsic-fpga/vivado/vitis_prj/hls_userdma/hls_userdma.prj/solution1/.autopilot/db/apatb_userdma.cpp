...
extern "C"
void userdma_hw_stub_wrapper(void*, void*, void*, void*, void*, void*, hls::sim::Byte<1>, hls::sim::Byte<4>*, hls::sim::Byte<1>*, void*, void*, hls::sim::Byte<4>*, void*, void*, hls::sim::Byte<1>, hls::sim::Byte<4>, hls::sim::Byte<1>*, void*, void*, void*, void*, void*);

extern "C"
void apatb_userdma_hw(void* __xlx_apatb_param_inStreamTop_V_data_V, void* __xlx_apatb_param_inStreamTop_V_keep_V, void* __xlx_apatb_param_inStreamTop_V_strb_V, void* __xlx_apatb_param_inStreamTop_V_user_V, void* __xlx_apatb_param_inStreamTop_V_last_V, void* __xlx_apatb_param_s2m_buf_sts, hls::sim::Byte<1> __xlx_apatb_param_s2m_sts_clear, hls::sim::Byte<4>* __xlx_apatb_param_s2m_len, hls::sim::Byte<1>* __xlx_apatb_param_s2m_enb_clrsts, void* __xlx_apatb_param_s2mbuf, void* __xlx_apatb_param_s2m_err, hls::sim::Byte<4>* __xlx_apatb_param_Img_width, void* __xlx_apatb_param_m2sbuf, void* __xlx_apatb_param_m2s_buf_sts, hls::sim::Byte<1> __xlx_apatb_param_m2s_sts_clear, hls::sim::Byte<4> __xlx_apatb_param_m2s_len, hls::sim::Byte<1>* __xlx_apatb_param_m2s_enb_clrsts, void* __xlx_apatb_param_outStreamTop_V_data_V, void* __xlx_apatb_param_outStreamTop_V_keep_V, void* __xlx_apatb_param_outStreamTop_V_strb_V, void* __xlx_apatb_param_outStreamTop_V_user_V, void* __xlx_apatb_param_outStreamTop_V_last_V)
{
  static hls::sim::Stream<hls::sim::Byte<4>> port0 {
    .width = 32,
    .name = "inStreamTop_V_data_V",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_inStreamTop_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_inStreamTop_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_inStreamTop_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_inStreamTop_V_data_V),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_inStreamTop_V_data_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_inStreamTop_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_inStreamTop_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_inStreamTop_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_inStreamTop_V_keep_V),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_inStreamTop_V_keep_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_inStreamTop_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_inStreamTop_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_inStreamTop_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_inStreamTop_V_strb_V),
#endif
  };
  port2.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_inStreamTop_V_strb_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_inStreamTop_V_user_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_inStreamTop_V_user_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_inStreamTop_V_user_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_inStreamTop_V_user_V),
#endif
  };
  port3.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_inStreamTop_V_user_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_inStreamTop_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_inStreamTop_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_inStreamTop_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_inStreamTop_V_last_V),
#endif
  };
  port4.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_inStreamTop_V_last_V;
  ...
  static hls::sim::Register port5 {
    ...
    .width = 1,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_s2m_buf_sts),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_s2m_buf_sts),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_s2m_buf_sts),
#endif
  };
  port5.param = __xlx_apatb_param_s2m_buf_sts;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_s2m_sts_clear),
#endif
  };
  port6.param = &__xlx_apatb_param_s2m_sts_clear;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_s2m_len),
#endif
  };
  port7.param = __xlx_apatb_param_s2m_len;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_s2m_enb_clrsts),
#endif
  };
  port8.param = __xlx_apatb_param_s2m_enb_clrsts;

  hls::sim::Byte<4> __xlx_offset_byte_param_s2mbuf;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_s2mbuf),
#endif
  };
  port9.param = &__xlx_offset_byte_param_s2mbuf;

  static hls::sim::Register port10 {
    .name = "s2m_err",
    .width = 1,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_s2m_err),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_s2m_err),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_s2m_err),
#endif
  };
  port10.param = __xlx_apatb_param_s2m_err;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_Img_width),
#endif
  };
  port11.param = __xlx_apatb_param_Img_width;

  hls::sim::Byte<4> __xlx_offset_byte_param_m2sbuf;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_m2sbuf),
#endif
  };
  port12.param = &__xlx_offset_byte_param_m2sbuf;

  static hls::sim::Register port13 {
    .name = "m2s_buf_sts",
    .width = 1,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_m2s_buf_sts),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_m2s_buf_sts),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_m2s_buf_sts),
#endif
  };
  port13.param = __xlx_apatb_param_m2s_buf_sts;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_m2s_sts_clear),
#endif
  };
  port14.param = &__xlx_apatb_param_m2s_sts_clear;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_m2s_len),
#endif
  };
  port15.param = &__xlx_apatb_param_m2s_len;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_m2s_enb_clrsts),
#endif
  };
  port16.param = __xlx_apatb_param_m2s_enb_clrsts;

  static hls::sim::Stream<hls::sim::Byte<4>> port17 {
    .width = 32,
    .name = "outStreamTop_V_data_V",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_outStreamTop_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_outStreamTop_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_outStreamTop_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_outStreamTop_V_data_V),
#endif
  };
  port17.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_outStreamTop_V_data_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_outStreamTop_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_outStreamTop_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_outStreamTop_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_outStreamTop_V_keep_V),
#endif
  };
  port18.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_outStreamTop_V_keep_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_outStreamTop_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_outStreamTop_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_outStreamTop_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_outStreamTop_V_strb_V),
#endif
  };
  port19.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_outStreamTop_V_strb_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_outStreamTop_V_user_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_outStreamTop_V_user_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_outStreamTop_V_user_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_outStreamTop_V_user_V),
#endif
  };
  port20.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_outStreamTop_V_user_V;
  port20.hasWrite = true;

  static hls::sim::Stream<hls::sim::Byte<1>> port21 {
    .width = 1,
    .name = "outStreamTop_V_last_V",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_outStreamTop_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_outStreamTop_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_outStreamTop_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_outStreamTop_V_last_V),
#endif
  };
  port21.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_outStreamTop_V_last_V;
  ...
  port22.param = { __xlx_apatb_param_s2mbuf };
  port22.nbytes = { 256 };
  port22.offset = {  };
  ...
  port23.param = { __xlx_apatb_param_m2sbuf };
  port23.nbytes = { 256 };
  port23.offset = {  };
