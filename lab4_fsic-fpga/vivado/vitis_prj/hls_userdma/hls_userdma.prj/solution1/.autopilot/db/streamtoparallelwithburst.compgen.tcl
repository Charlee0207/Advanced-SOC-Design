...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_incount \
    op interface \
    ports { incount_dout { I 32 vector } incount_num_data_valid { I 7 vector } incount_fifo_cap { I 7 vector } incount_empty_n { I 1 bit } incount_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_en_clrsts_dout { I 1 vector } in_en_clrsts_num_data_valid { I 2 vector } in_en_clrsts_fifo_cap { I 2 vector } in_en_clrsts_empty_n { I 1 bit } in_en_clrsts_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_s2m_buf_sts \
    op interface \
    ports { s2m_buf_sts { O 1 vector } s2m_buf_sts_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_s2m_len_dout { I 32 vector } in_s2m_len_num_data_valid { I 2 vector } in_s2m_len_fifo_cap { I 2 vector } in_s2m_len_empty_n { I 1 bit } in_s2m_len_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_out_memory \
    op interface \
    ports { out_memory_dout { I 64 vector } out_memory_num_data_valid { I 3 vector } out_memory_fifo_cap { I 3 vector } out_memory_empty_n { I 1 bit } out_memory_read { O 1 bit } } \
} "
}
