...
set C_modelArgList {
	...
	{ in_Img_width int 32 regular  }
	{ inbuf int 33 regular {fifo 1 volatile }  }
	{ incount int 32 regular {fifo 1 volatile }  }
	{ s2m_len_c int 32 regular {fifo 1}  }
	{ s2m_enb_clrsts_c int 1 regular {fifo 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "inStreamTop_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in_Img_width", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "inbuf", "interface" : "fifo", "bitwidth" : 33, "direction" : "WRITEONLY"} , 
 	{ "Name" : "incount", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "s2m_len_c", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "s2m_enb_clrsts_c", "interface" : "fifo", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
# RTL Port declarations: 
set portNum 39
set portList { 
	...
	{ in_Img_width sc_in sc_lv 32 signal 8 } 
	{ inbuf_din sc_out sc_lv 33 signal 9 } 
	{ inbuf_num_data_valid sc_in sc_lv 11 signal 9 } 
	{ inbuf_fifo_cap sc_in sc_lv 11 signal 9 } 
	{ inbuf_full_n sc_in sc_logic 1 signal 9 } 
	{ inbuf_write sc_out sc_logic 1 signal 9 } 
	{ incount_din sc_out sc_lv 32 signal 10 } 
	{ incount_num_data_valid sc_in sc_lv 7 signal 10 } 
	{ incount_fifo_cap sc_in sc_lv 7 signal 10 } 
	{ incount_full_n sc_in sc_logic 1 signal 10 } 
	{ incount_write sc_out sc_logic 1 signal 10 } 
	{ s2m_len_c_din sc_out sc_lv 32 signal 11 } 
	{ s2m_len_c_num_data_valid sc_in sc_lv 2 signal 11 } 
	{ s2m_len_c_fifo_cap sc_in sc_lv 2 signal 11 } 
	{ s2m_len_c_full_n sc_in sc_logic 1 signal 11 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inbuf_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "inbuf", "role": "full_n" }} , 
 	{ "name": "inbuf_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "inbuf", "role": "write" }} , 
 	{ "name": "incount_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "incount", "role": "din" }} , 
 	{ "name": "incount_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "incount", "role": "num_data_valid" }} , 
 	{ "name": "incount_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "incount", "role": "fifo_cap" }} , 
 	{ "name": "incount_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "incount", "role": "full_n" }} , 
 	{ "name": "incount_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "incount", "role": "write" }} , 
 	{ "name": "s2m_len_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "s2m_len_c", "role": "din" }} , 
 	{ "name": "s2m_len_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "s2m_len_c", "role": "num_data_valid" }} , 
 	{ "name": "s2m_len_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "s2m_len_c", "role": "fifo_cap" }} , 
 	{ "name": "s2m_len_c_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s2m_len_c", "role": "full_n" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			{"Name" : "inStreamTop_V_data_V", "Type" : "Axis", "Direction" : "I", "BaseName" : "inStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_134", "Port" : "inStreamTop_V_data_V", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "inStreamTop_V_keep_V", "Type" : "Axis", "Direction" : "I", "BaseName" : "inStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_134", "Port" : "inStreamTop_V_keep_V", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "inStreamTop_V_strb_V", "Type" : "Axis", "Direction" : "I", "BaseName" : "inStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_134", "Port" : "inStreamTop_V_strb_V", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "inStreamTop_V_user_V", "Type" : "Axis", "Direction" : "I", "BaseName" : "inStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_134", "Port" : "inStreamTop_V_user_V", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "inStreamTop_V_last_V", "Type" : "Axis", "Direction" : "I", "BaseName" : "inStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_134", "Port" : "inStreamTop_V_last_V", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "in_en_clrsts", "Type" : "None", "Direction" : "I"},
			{"Name" : "in_s2m_len", "Type" : "None", "Direction" : "I"},
			{"Name" : "s2m_err", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "in_Img_width", "Type" : "None", "Direction" : "I"},
			{"Name" : "inbuf", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_134", "Port" : "inbuf", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "incount", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_134", "Port" : "incount", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "s2m_len_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "s2m_len_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "s2m_enb_clrsts_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
			...
			{"Name" : "width_count", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_134", "Port" : "width_count", "Inst_start_state" : "1", "Inst_end_state" : "2"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_134", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "getinstream_Pipeline_VITIS_LOOP_48_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_48_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter1", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter2", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_134.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_inStreamTop_V_data_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_inStreamTop_V_keep_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_inStreamTop_V_strb_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_inStreamTop_V_user_V_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	incount { ap_fifo {  { incount_din fifo_port_we 1 32 }  { incount_num_data_valid fifo_status_num_data_valid 0 7 }  { incount_fifo_cap fifo_update 0 7 }  { incount_full_n fifo_status 0 1 }  { incount_write fifo_data 1 1 } } }
	s2m_len_c { ap_fifo {  { s2m_len_c_din fifo_port_we 1 32 }  { s2m_len_c_num_data_valid fifo_status_num_data_valid 0 2 }  { s2m_len_c_fifo_cap fifo_update 0 2 }  { s2m_len_c_full_n fifo_status 0 1 }  { s2m_len_c_write fifo_data 1 1 } } }
	s2m_enb_clrsts_c { ap_fifo {  { s2m_enb_clrsts_c_din fifo_port_we 1 1 }  { s2m_enb_clrsts_c_num_data_valid fifo_status_num_data_valid 0 2 }  { s2m_enb_clrsts_c_fifo_cap fifo_update 0 2 }  { s2m_enb_clrsts_c_full_n fifo_status 0 1 }  { s2m_enb_clrsts_c_write fifo_data 1 1 } } }
}
set moduleName getinstream
