...
set C_modelArgList {
	...
	{ in_m2s_len int 32 regular  }
	{ outbuf int 40 regular {fifo 1 volatile }  }
	{ outcount int 32 regular {fifo 1 volatile }  }
	{ m2s_enb_clrsts_c int 1 regular {fifo 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "m2sbuf","offset": { "type": "dynamic","port_name": "m2sbuf","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "in_m2s_len", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "outbuf", "interface" : "fifo", "bitwidth" : 40, "direction" : "WRITEONLY"} , 
 	{ "Name" : "outcount", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "m2s_enb_clrsts_c", "interface" : "fifo", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
# RTL Port declarations: 
set portNum 72
set portList { 
	...
	{ outbuf_full_n sc_in sc_logic 1 signal 5 } 
	{ outbuf_write sc_out sc_logic 1 signal 5 } 
	{ outcount_din sc_out sc_lv 32 signal 6 } 
	{ outcount_num_data_valid sc_in sc_lv 7 signal 6 } 
	{ outcount_fifo_cap sc_in sc_lv 7 signal 6 } 
	{ outcount_full_n sc_in sc_logic 1 signal 6 } 
	{ outcount_write sc_out sc_logic 1 signal 6 } 
	{ m2s_enb_clrsts_c_din sc_out sc_lv 1 signal 7 } 
	{ m2s_enb_clrsts_c_num_data_valid sc_in sc_lv 2 signal 7 } 
	{ m2s_enb_clrsts_c_fifo_cap sc_in sc_lv 2 signal 7 } 
	{ m2s_enb_clrsts_c_full_n sc_in sc_logic 1 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outbuf_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outbuf", "role": "full_n" }} , 
 	{ "name": "outbuf_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outbuf", "role": "write" }} , 
 	{ "name": "outcount_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "outcount", "role": "din" }} , 
 	...
 	{ "name": "outcount_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outcount", "role": "full_n" }} , 
 	{ "name": "outcount_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outcount", "role": "write" }} , 
 	{ "name": "m2s_enb_clrsts_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "m2s_enb_clrsts_c", "role": "din" }} , 
 	{ "name": "m2s_enb_clrsts_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "m2s_enb_clrsts_c", "role": "num_data_valid" }} , 
 	{ "name": "m2s_enb_clrsts_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "m2s_enb_clrsts_c", "role": "fifo_cap" }} , 
 	{ "name": "m2s_enb_clrsts_c_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "m2s_enb_clrsts_c", "role": "full_n" }} , 
...
set RtlHierarchyInfo {[
		...
		"Port" : [
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "gmem1_blk_n_AR", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2_fu_173", "Port" : "gmem1", "Inst_start_state" : "21", "Inst_end_state" : "22"}]},
			{"Name" : "in_memory", "Type" : "None", "Direction" : "I"},
			{"Name" : "in_en_clrsts", "Type" : "None", "Direction" : "I"},
			{"Name" : "in_Img_width", "Type" : "None", "Direction" : "I"},
			{"Name" : "in_m2s_len", "Type" : "None", "Direction" : "I"},
			{"Name" : "outbuf", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2_fu_173", "Port" : "outbuf", "Inst_start_state" : "21", "Inst_end_state" : "22"}]},
			{"Name" : "outcount", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "m2s_len", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2_fu_173", "Port" : "m2s_len", "Inst_start_state" : "21", "Inst_end_state" : "22"}]},
			{"Name" : "Img_width_count", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2_fu_173", "Port" : "Img_width_count", "Inst_start_state" : "21", "Inst_end_state" : "22"}]}],
		"Loop" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2_fu_173", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2_fu_173.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	outcount { ap_fifo {  { outcount_din fifo_port_we 1 32 }  { outcount_num_data_valid fifo_status_num_data_valid 0 7 }  { outcount_fifo_cap fifo_update 0 7 }  { outcount_full_n fifo_status 0 1 }  { outcount_write fifo_data 1 1 } } }
	m2s_enb_clrsts_c { ap_fifo {  { m2s_enb_clrsts_c_din fifo_port_we 1 1 }  { m2s_enb_clrsts_c_num_data_valid fifo_status_num_data_valid 0 2 }  { m2s_enb_clrsts_c_fifo_cap fifo_update 0 2 }  { m2s_enb_clrsts_c_full_n fifo_status 0 1 }  { m2s_enb_clrsts_c_write fifo_data 1 1 } } }
}
set moduleName paralleltostreamwithburst
set isTopModule 0
