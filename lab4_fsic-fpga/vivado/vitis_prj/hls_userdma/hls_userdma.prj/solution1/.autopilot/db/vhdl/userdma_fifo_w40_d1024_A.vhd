...
entity userdma_fifo_w40_d1024_A is
    generic (
...
architecture arch of userdma_fifo_w40_d1024_A is

    -- component
    component userdma_fifo_w40_d1024_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_userdma_fifo_w40_d1024_A_ram : userdma_fifo_w40_d1024_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity userdma_fifo_w40_d1024_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 40;
        ADDR_WIDTH  : integer := 10;
...
architecture arch of userdma_fifo_w40_d1024_A_ram is
