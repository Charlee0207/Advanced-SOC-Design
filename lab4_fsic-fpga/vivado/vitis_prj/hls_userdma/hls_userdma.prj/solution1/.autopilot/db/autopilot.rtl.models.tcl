set SynModuleInfo {
  ...
  {SRCNAME paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2 MODELNAME paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2 RTLNAME userdma_paralleltostreamwithburst_Pipeline_VITIS_LOOP_106_2}
  {SRCNAME paralleltostreamwithburst MODELNAME paralleltostreamwithburst RTLNAME userdma_paralleltostreamwithburst}
  {SRCNAME sendoutstream_Pipeline_VITIS_LOOP_149_2 MODELNAME sendoutstream_Pipeline_VITIS_LOOP_149_2 RTLNAME userdma_sendoutstream_Pipeline_VITIS_LOOP_149_2}
  ...
  {SRCNAME userdma MODELNAME userdma RTLNAME userdma IS_TOP 1
    SUBMODULES {
      {MODELNAME userdma_fifo_w1_d3_S RTLNAME userdma_fifo_w1_d3_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME s2m_sts_clear_c_U}
      ...
      {MODELNAME userdma_fifo_w1_d3_S RTLNAME userdma_fifo_w1_d3_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME m2s_sts_clear_c_U}
      {MODELNAME userdma_fifo_w33_d1024_A RTLNAME userdma_fifo_w33_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME inbuf_U}
      {MODELNAME userdma_fifo_w32_d64_A RTLNAME userdma_fifo_w32_d64_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME incount_U}
      ...
      {MODELNAME userdma_fifo_w40_d1024_A RTLNAME userdma_fifo_w40_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME outbuf_U}
      {MODELNAME userdma_fifo_w32_d64_A RTLNAME userdma_fifo_w32_d64_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME outcount_U}
