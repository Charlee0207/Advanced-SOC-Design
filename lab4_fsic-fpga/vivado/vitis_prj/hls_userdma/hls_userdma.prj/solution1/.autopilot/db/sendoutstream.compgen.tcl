...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { outStreamTop_TVALID { O 1 bit } outStreamTop_TREADY { I 1 bit } outStreamTop_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outcount_dout { I 32 vector } outcount_num_data_valid { I 7 vector } outcount_fifo_cap { I 7 vector } outcount_empty_n { I 1 bit } outcount_read { O 1 bit } } \
} "
}
