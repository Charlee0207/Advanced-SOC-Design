...
wire tap_WE_merge, tap_RE;
wire [pADDR_WIDTH-1:0] tap_A_shifted;
wire [pDATA_WIDTH-1:0] tap_Di, tap_Do;

wire data_WE_merge, data_RE;
wire [pADDR_WIDTH-1:0] data_A_shifted;
wire [pDATA_WIDTH-1:0] data_Di, data_Do;
...
// tap bram module initiation
bram11 #(
    .ADDR_WIDTH(pADDR_WIDTH),
    .BIT_WIDTH(pDATA_WIDTH)
) U0_tap (
    .clk(axis_clk),
    .we(tap_WE_merge),
    .re(tap_RE),
    .waddr(tap_A_shifted),
    .raddr(tap_A_shifted), // Assuming read address is the same as write address
    .wdi(tap_Di),
    .rdo(tap_Do)
);

// data bram module initiation
bram11 #(
    .ADDR_WIDTH(pADDR_WIDTH),
    .BIT_WIDTH(pDATA_WIDTH)
) U0_data (
    ...
    .raddr(data_A_shifted), // Assuming read address is the same as write address
    .wdi(data_Di),
    .rdo(data_Do)
);
